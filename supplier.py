...
class supplierClass:
    ...
    #Combobox
        ...
        txt_serch=Entry(self.root,textvariable=self.var_searchtxt,font=("goudy old  style",15),bg="lightyellow").place(x=800,y=80,width=170)
        btn_serch=Button(self.root,text="search",command=self.search,font=("goudy old  style",15),bg="#4caf50",fg="white",cursor="hand2").place(x=980,y=79,width=100,height=28)
    ...
    # Row1
        ...
        lbl_suplier_invoice=Label(self.root,text="Invoice No.",font=("goudy old  style",15),bg="white").place(x=50,y=80)
        txt_suplier_invoice=Entry(self.root,textvariable=self.var_sup_invoice,font=("goudy old  style",15),bg="lightyellow").place(x=180,y=80,width=180)
    ...
    def add(self):
        ...
        try:
            if self.var_sup_invoice.get()=="":
                ...
                row=cur.fetchone()
                if row!=None:
                    messagebox.showerror("Error","Invoice No. already assigend, try different",parent=self.root)
                else:
                    ...
                    con.commit()
                    messagebox.showinfo("Success","Supplier Addedd Scuccessfully",parent=self.root)
                    self.show()                                                                     
    ...
    def update(self):
        ...
        try:
            if self.var_sup_invoice.get()=="":
                ...
                row=cur.fetchone()
                if row==None:
                    messagebox.showerror("Error","Invalid Invoice No. ID ",parent=self.root)
                else:
                    ...
                    con.commit()
                    messagebox.showinfo("Success","Supplier Update Scuccessfully",parent=self.root)
                    self.show()                                                                     
