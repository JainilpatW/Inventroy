...
class BillClass:
    def __init__(self,root,):
        ...
        lbl_search=Label(ProductFrame2,text="Product Name",font=("time new roman",13,"bold"),bg="white").place(x=2,y=45)
        lbl_search=Entry(ProductFrame2,textvariable=self.var_search,font=("time new roman",15),bg="lightyellow").place(x=128,y=47,width=150,height=22)
        ...
        ProductFrame3.place(x=2,y=140,width=400,height=380)
        ...
        lbl_note=Label(ProductFrame1,text="Note:'Enter  0 Qunative remove product from the Cart'",font=("goudy old style",12),anchor="w",bg="white",fg="red").pack(side=BOTTOM,fill=X)
...
# ================ Customer Frame ================================
        ...
        cTitle=Label(CustomerFrame,text="Customer Datils",font=("goudy old style",15),bg="lightgray").pack(side=TOP,fill=X)

        lbl_name=Label(CustomerFrame,text="Name",font=("time new roman",13),bg="white").place(x=5,y=35)
        lbl_name=Entry(CustomerFrame,textvariable=self.var_cname,font=("time new roman",13),bg="lightyellow").place(x=75,y=35,width=180)

        lbl_contact=Label(CustomerFrame,text="Contact No.",font=("time new roman",13),bg="white").place(x=270,y=35)
        lbl_contact=Entry(CustomerFrame,textvariable=self.var_contact,font=("time new roman",13),bg="lightyellow").place(x=375,y=35,width=140)
     ...
     # ==========  Add CareWidgets  ===========
        ...
        Add_CarWidgetsFrame=Frame(self.root,bd=2,relief=RIDGE,bg="white")
        Add_CarWidgetsFrame.place(x=420,y=550,width=530,height=110)

        lbl_p_name=Label(Add_CarWidgetsFrame,text="Product Name",font=("time new roman",15),bg="white").place(x=5,y=5)
        txt_p_name=Entry(Add_CarWidgetsFrame,textvariable=self.var_pname,font=("time new roman",15),bg="lightyellow",state="readonly").place(x=5,y=35,width=190,height=22)

        lbl_p_price=Label(Add_CarWidgetsFrame,text="Price Per Qty",font=("time new roman",15),bg="white").place(x=230,y=5)
        txt_p_price=Entry(Add_CarWidgetsFrame,textvariable=self.var_price,font=("time new roman",15),bg="lightyellow",state="readonly").place(x=230,y=35,width=150,height=22)
 
        lbl_p_qty=Label(Add_CarWidgetsFrame,text="Quantity",font=("time new roman",15),bg="white").place(x=400,y=5)
        txt_p_qty=Entry(Add_CarWidgetsFrame,textvariable=self.var_qty,font=("time new roman",15),bg="lightyellow",).place(x=400,y=35,width=120,height=22)


        self.lbl_inStock=Label(Add_CarWidgetsFrame,text="In stock",font=("time new roman",15),bg="white")
        self.lbl_inStock.place(x=5,y=70)

        btn_clear_cart=Button(Add_CarWidgetsFrame,text="Clear",command=self.clear_cart,font=("time new roman",15,"bold"),bg="lightgray",cursor="hand2").place(x=180,y=70,width=150,height=30)
        btn_add_cart=Button(Add_CarWidgetsFrame,text="Add | Update Cart",command=self.add_update_cart,font=("time new roman",15,"bold"),bg="orange",cursor="hand2").place(x=340,y=70,width=180,height=30)
        ...
        self.lbl_amnt=Label(billMenuFrame,text='Bill Amount\n[0]',font=("goudy old style",15,"bold"),bg='#3f51bf',fg="white")
        ...
        self.lbl_net_pay.place(x=247,y=5,width=160,height=70)
        ...
        btn_genretn=Button(billMenuFrame,text='Genrent/Save Bill',command=self.generate_bill,cursor="hand2",font=("goudy old style",15,"bold"),bg='#009688',fg="white")
        btn_genretn.place(x=246,y=80,width=160,height=50)

        #=========== Footer =========

        footer=Label(self.root,text="IMS-Inventory Management System | Devepoed By Apple \n For any Technical Issue  contact:70xxxxx70",font=('time new roman,',11),bg="#4d636d",fg="white",activebackground="White").pack(side=BOTTOM,fill=X)
...
#==================== All Functio ==============================
    ...
    def search(self):
        ...
        try:
            if self.var_search.get()=="":
                messagebox.showerror("Error","Select input must be required",parent=self.root)    
                ...
                if len(rows)!=0:
                    ...
                    messagebox.showerror("Erorr","No recode found!!!",parent=self.root)         
    ...
    def add_update_cart(self):
        if self.var_pid.get()=='':
            messagebox.showerror('Error',"Pleae select product from the list",parent=self.root)
    ...
    def generate_bill(self):
        if self.var_cname.get()=='' or self.var_contact.get()=='':
            messagebox.showerror("Error",f"Custome details are required",parent=self.root)
...
{str("="*47)}\n
    ...
    def print_bill(self):
        if self.chk_print==1:
            messagebox.showinfo('print','Plesae wait while printing',parent=self.root)
            new_fille=tempfile.mktemp('.txt')
            open(new_fille,'w').write(self.txt_bill_area.get('1.0',END))
            os.startfile(new_fille,'print')
        else:    
            messagebox.showinfo('print','Plesae generate bill, to no print recepit ',parent=self.root)
