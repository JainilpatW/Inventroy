...
class productClass:
    ...
    #Combobox
        ...
        cmd_serach=ttk.Combobox(searchFrame,textvariable=self.var_searchby,values=("Select","Category","Supplier","Name"),state='readonly',justify=CENTER,font=("goudy old  style",15))
        ...
        try:
            if self.var_cat.get()=="Select" or self.var_cat.get()=="Empty" or self.var_sup.get()=="Select" or self.var_name.get()=="":
                ...
                if row!=None:
                    ...
                    con.commit()
                    messagebox.showinfo("Success","Product Addedd Scuccessfully",parent=self.root)
                    self.show()                                                                     
    ...
    def update(self):
        ...
        try:
            if self.var_pid.get()=="":
                messagebox.showerror("error","Please select productfrom list",parent=self.root)
            else:
                ...
                if row==None:
                    ...
                    con.commit()
                    messagebox.showinfo("Success","Product Update Scuccessfully",parent=self.root)
                    self.show()                                                                     
